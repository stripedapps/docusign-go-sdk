...
func (o *ErrorDetails) GetError() string {
...
func (o *ErrorDetails) GetErrorOk() (*string, bool) {
	if o == nil || IsNil(o.Error) {
		return nil, false
	}
	return o.Error, true
...
func (o *ErrorDetails) HasError() bool {
	if o != nil && !IsNil(o.Error) {
		return true
	}
...
func (o *ErrorDetails) SetError(v string) {
	o.Error = &v
}

// GetErrorDescription returns the ErrorDescription field value if set, zero value otherwise.
func (o *ErrorDetails) GetErrorDescription() string {
...
// and a boolean to check if the value has been set.
func (o *ErrorDetails) GetErrorDescriptionOk() (*string, bool) {
	if o == nil || IsNil(o.ErrorDescription) {
		return nil, false
	}
...
func (o *ErrorDetails) HasErrorDescription() bool {
	if o != nil && !IsNil(o.ErrorDescription) {
		return true
	}
...
func (o *ErrorDetails) SetErrorDescription(v string) {
