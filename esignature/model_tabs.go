...
// checks if the Tabs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Tabs{}

// Tabs Tabs indicate to recipients where they should sign, initial, or enter data on a document. They are represented graphically as symbols on documents at the time of signing. Tabs can also display data to the recipients.
type Tabs struct {
...
// NewTabs instantiates a new Tabs object
...
// NewTabsWithDefaults instantiates a new Tabs object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTabsWithDefaults() *Tabs {
	this := Tabs{}
	return &this
}

// GetApproveTabs returns the ApproveTabs field value if set, zero value otherwise.
func (o *Tabs) GetApproveTabs() []Approve {
...
func (o *Tabs) GetApproveTabsOk() ([]Approve, bool) {
	if o == nil || IsNil(o.ApproveTabs) {
		return nil, false
	}
...
func (o *Tabs) HasApproveTabs() bool {
	if o != nil && !IsNil(o.ApproveTabs) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetCheckboxTabsOk() ([]Checkbox, bool) {
	if o == nil || IsNil(o.CheckboxTabs) {
		return nil, false
	}
...
func (o *Tabs) HasCheckboxTabs() bool {
	if o != nil && !IsNil(o.CheckboxTabs) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetCommentThreadTabsOk() ([]CommentThread, bool) {
	if o == nil || IsNil(o.CommentThreadTabs) {
		return nil, false
	}
...
func (o *Tabs) HasCommentThreadTabs() bool {
	if o != nil && !IsNil(o.CommentThreadTabs) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetCommissionCountyTabsOk() ([]CommissionCounty, bool) {
	if o == nil || IsNil(o.CommissionCountyTabs) {
		return nil, false
	}
...
func (o *Tabs) HasCommissionCountyTabs() bool {
	if o != nil && !IsNil(o.CommissionCountyTabs) {
		return true
	}
...
func (o *Tabs) SetCommissionCountyTabs(v []CommissionCounty) {
...
func (o *Tabs) GetCommissionExpirationTabs() []CommissionExpiration {
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetCommissionExpirationTabsOk() ([]CommissionExpiration, bool) {
	if o == nil || IsNil(o.CommissionExpirationTabs) {
		return nil, false
	}
...
func (o *Tabs) HasCommissionExpirationTabs() bool {
	if o != nil && !IsNil(o.CommissionExpirationTabs) {
		return true
	}
...
func (o *Tabs) SetCommissionExpirationTabs(v []CommissionExpiration) {
...
func (o *Tabs) GetCommissionNumberTabs() []CommissionNumber {
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetCommissionNumberTabsOk() ([]CommissionNumber, bool) {
	if o == nil || IsNil(o.CommissionNumberTabs) {
		return nil, false
	}
...
func (o *Tabs) HasCommissionNumberTabs() bool {
	if o != nil && !IsNil(o.CommissionNumberTabs) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetCommissionStateTabsOk() ([]CommissionState, bool) {
	if o == nil || IsNil(o.CommissionStateTabs) {
		return nil, false
	}
...
func (o *Tabs) HasCommissionStateTabs() bool {
	if o != nil && !IsNil(o.CommissionStateTabs) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetCompanyTabsOk() ([]Company, bool) {
	if o == nil || IsNil(o.CompanyTabs) {
		return nil, false
	}
...
func (o *Tabs) HasCompanyTabs() bool {
	if o != nil && !IsNil(o.CompanyTabs) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetDateSignedTabsOk() ([]DateSigned, bool) {
	if o == nil || IsNil(o.DateSignedTabs) {
		return nil, false
	}
...
func (o *Tabs) HasDateSignedTabs() bool {
	if o != nil && !IsNil(o.DateSignedTabs) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetDateTabsOk() ([]Date, bool) {
	if o == nil || IsNil(o.DateTabs) {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetDeclineTabsOk() ([]Decline, bool) {
	if o == nil || IsNil(o.DeclineTabs) {
		return nil, false
	}
...
func (o *Tabs) HasDeclineTabs() bool {
	if o != nil && !IsNil(o.DeclineTabs) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetDrawTabsOk() ([]Draw, bool) {
	if o == nil || IsNil(o.DrawTabs) {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetEmailAddressTabsOk() ([]EmailAddress, bool) {
	if o == nil || IsNil(o.EmailAddressTabs) {
		return nil, false
	}
...
func (o *Tabs) HasEmailAddressTabs() bool {
	if o != nil && !IsNil(o.EmailAddressTabs) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetEmailTabsOk() ([]Email, bool) {
	if o == nil || IsNil(o.EmailTabs) {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetEnvelopeIdTabsOk() ([]EnvelopeId, bool) {
	if o == nil || IsNil(o.EnvelopeIdTabs) {
		return nil, false
	}
...
func (o *Tabs) HasEnvelopeIdTabs() bool {
	if o != nil && !IsNil(o.EnvelopeIdTabs) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetFirstNameTabsOk() ([]FirstName, bool) {
	if o == nil || IsNil(o.FirstNameTabs) {
		return nil, false
	}
...
func (o *Tabs) HasFirstNameTabs() bool {
	if o != nil && !IsNil(o.FirstNameTabs) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetFormulaTabsOk() ([]FormulaTab, bool) {
	if o == nil || IsNil(o.FormulaTabs) {
		return nil, false
	}
...
func (o *Tabs) HasFormulaTabs() bool {
	if o != nil && !IsNil(o.FormulaTabs) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetFullNameTabsOk() ([]FullName, bool) {
	if o == nil || IsNil(o.FullNameTabs) {
		return nil, false
	}
...
func (o *Tabs) HasFullNameTabs() bool {
	if o != nil && !IsNil(o.FullNameTabs) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetInitialHereTabsOk() ([]InitialHere, bool) {
	if o == nil || IsNil(o.InitialHereTabs) {
		return nil, false
	}
...
func (o *Tabs) HasInitialHereTabs() bool {
	if o != nil && !IsNil(o.InitialHereTabs) {
		return true
	}
...
func (o *Tabs) SetInitialHereTabs(v []InitialHere) {
	o.InitialHereTabs = v
}

// GetLastNameTabs returns the LastNameTabs field value if set, zero value otherwise.
func (o *Tabs) GetLastNameTabs() []LastName {
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetLastNameTabsOk() ([]LastName, bool) {
	if o == nil || IsNil(o.LastNameTabs) {
		return nil, false
	}
...
func (o *Tabs) HasLastNameTabs() bool {
	if o != nil && !IsNil(o.LastNameTabs) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetListTabsOk() ([]List, bool) {
	if o == nil || IsNil(o.ListTabs) {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetNotarizeTabsOk() ([]Notarize, bool) {
	if o == nil || IsNil(o.NotarizeTabs) {
		return nil, false
	}
...
func (o *Tabs) HasNotarizeTabs() bool {
	if o != nil && !IsNil(o.NotarizeTabs) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetNotarySealTabsOk() ([]NotarySeal, bool) {
	if o == nil || IsNil(o.NotarySealTabs) {
		return nil, false
	}
...
func (o *Tabs) HasNotarySealTabs() bool {
	if o != nil && !IsNil(o.NotarySealTabs) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetNoteTabsOk() ([]Note, bool) {
	if o == nil || IsNil(o.NoteTabs) {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetNumberTabsOk() ([]Number, bool) {
	if o == nil || IsNil(o.NumberTabs) {
		return nil, false
	}
...
func (o *Tabs) HasNumberTabs() bool {
	if o != nil && !IsNil(o.NumberTabs) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetNumericalTabsOk() ([]Numerical, bool) {
	if o == nil || IsNil(o.NumericalTabs) {
		return nil, false
	}
...
func (o *Tabs) HasNumericalTabs() bool {
	if o != nil && !IsNil(o.NumericalTabs) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetPhoneNumberTabsOk() ([]PhoneNumber, bool) {
	if o == nil || IsNil(o.PhoneNumberTabs) {
		return nil, false
	}
...
func (o *Tabs) HasPhoneNumberTabs() bool {
	if o != nil && !IsNil(o.PhoneNumberTabs) {
		return true
	}
...
func (o *Tabs) SetPhoneNumberTabs(v []PhoneNumber) {
	o.PhoneNumberTabs = v
}

// GetPolyLineOverlayTabs returns the PolyLineOverlayTabs field value if set, zero value otherwise.
func (o *Tabs) GetPolyLineOverlayTabs() []PolyLineOverlay {
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetPolyLineOverlayTabsOk() ([]PolyLineOverlay, bool) {
	if o == nil || IsNil(o.PolyLineOverlayTabs) {
		return nil, false
	}
...
func (o *Tabs) HasPolyLineOverlayTabs() bool {
	if o != nil && !IsNil(o.PolyLineOverlayTabs) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetPrefillTabsOk() (*PrefillTabs, bool) {
	if o == nil || IsNil(o.PrefillTabs) {
		return nil, false
	}
...
func (o *Tabs) HasPrefillTabs() bool {
	if o != nil && !IsNil(o.PrefillTabs) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetRadioGroupTabsOk() ([]RadioGroup, bool) {
	if o == nil || IsNil(o.RadioGroupTabs) {
		return nil, false
	}
...
func (o *Tabs) HasRadioGroupTabs() bool {
	if o != nil && !IsNil(o.RadioGroupTabs) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetSignerAttachmentTabsOk() ([]SignerAttachment, bool) {
	if o == nil || IsNil(o.SignerAttachmentTabs) {
		return nil, false
	}
...
func (o *Tabs) HasSignerAttachmentTabs() bool {
	if o != nil && !IsNil(o.SignerAttachmentTabs) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetSignHereTabsOk() ([]SignHere, bool) {
	if o == nil || IsNil(o.SignHereTabs) {
		return nil, false
	}
...
func (o *Tabs) HasSignHereTabs() bool {
	if o != nil && !IsNil(o.SignHereTabs) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetSmartSectionTabsOk() ([]SmartSection, bool) {
	if o == nil || IsNil(o.SmartSectionTabs) {
		return nil, false
	}
...
func (o *Tabs) HasSmartSectionTabs() bool {
	if o != nil && !IsNil(o.SmartSectionTabs) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetSsnTabsOk() ([]Ssn, bool) {
	if o == nil || IsNil(o.SsnTabs) {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetTabGroupsOk() ([]TabGroup, bool) {
	if o == nil || IsNil(o.TabGroups) {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetTextTabsOk() ([]Text, bool) {
	if o == nil || IsNil(o.TextTabs) {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetTitleTabsOk() ([]Title, bool) {
	if o == nil || IsNil(o.TitleTabs) {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetViewTabsOk() ([]View, bool) {
	if o == nil || IsNil(o.ViewTabs) {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *Tabs) GetZipTabsOk() ([]Zip, bool) {
	if o == nil || IsNil(o.ZipTabs) {
		return nil, false
	}
...
func (o *Tabs) SetZipTabs(v []Zip) {
	o.ZipTabs = v
}

func (o Tabs) MarshalJSON() ([]byte, error) {
...
func (o Tabs) ToMap() (map[string]interface{}, error) {
...
type NullableTabs struct {
	value *Tabs
	isSet bool
}

func (v NullableTabs) Get() *Tabs {
	return v.value
}

func (v *NullableTabs) Set(val *Tabs) {
	v.value = val
	v.isSet = true
}

func (v NullableTabs) IsSet() bool {
	return v.isSet
}

func (v *NullableTabs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTabs(val *Tabs) *NullableTabs {
	return &NullableTabs{value: val, isSet: true}
}

func (v NullableTabs) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTabs) UnmarshalJSON(src []byte) error {
	v.isSet = true
