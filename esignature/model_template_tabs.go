...
// checks if the TemplateTabs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TemplateTabs{}
...
// NewTemplateTabs instantiates a new TemplateTabs object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewTemplateTabs() *TemplateTabs {
	this := TemplateTabs{}
	return &this
}

// NewTemplateTabsWithDefaults instantiates a new TemplateTabs object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTemplateTabsWithDefaults() *TemplateTabs {
	this := TemplateTabs{}
	return &this
}

// GetApproveTabs returns the ApproveTabs field value if set, zero value otherwise.
func (o *TemplateTabs) GetApproveTabs() []Approve {
...
func (o *TemplateTabs) GetApproveTabsOk() ([]Approve, bool) {
	if o == nil || IsNil(o.ApproveTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasApproveTabs() bool {
	if o != nil && !IsNil(o.ApproveTabs) {
		return true
	}
...
func (o *TemplateTabs) SetApproveTabs(v []Approve) {
	o.ApproveTabs = v
}

// GetCheckboxTabs returns the CheckboxTabs field value if set, zero value otherwise.
func (o *TemplateTabs) GetCheckboxTabs() []Checkbox {
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetCheckboxTabsOk() ([]Checkbox, bool) {
	if o == nil || IsNil(o.CheckboxTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasCheckboxTabs() bool {
	if o != nil && !IsNil(o.CheckboxTabs) {
		return true
	}
...
func (o *TemplateTabs) SetCheckboxTabs(v []Checkbox) {
	o.CheckboxTabs = v
}

// GetCommentThreadTabs returns the CommentThreadTabs field value if set, zero value otherwise.
func (o *TemplateTabs) GetCommentThreadTabs() []CommentThread {
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetCommentThreadTabsOk() ([]CommentThread, bool) {
	if o == nil || IsNil(o.CommentThreadTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasCommentThreadTabs() bool {
	if o != nil && !IsNil(o.CommentThreadTabs) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetCommissionCountyTabsOk() ([]CommissionCounty, bool) {
	if o == nil || IsNil(o.CommissionCountyTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasCommissionCountyTabs() bool {
	if o != nil && !IsNil(o.CommissionCountyTabs) {
		return true
	}
...
func (o *TemplateTabs) SetCommissionCountyTabs(v []CommissionCounty) {
...
func (o *TemplateTabs) GetCommissionExpirationTabs() []CommissionExpiration {
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetCommissionExpirationTabsOk() ([]CommissionExpiration, bool) {
	if o == nil || IsNil(o.CommissionExpirationTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasCommissionExpirationTabs() bool {
	if o != nil && !IsNil(o.CommissionExpirationTabs) {
		return true
	}
...
func (o *TemplateTabs) SetCommissionExpirationTabs(v []CommissionExpiration) {
...
func (o *TemplateTabs) GetCommissionNumberTabs() []CommissionNumber {
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetCommissionNumberTabsOk() ([]CommissionNumber, bool) {
	if o == nil || IsNil(o.CommissionNumberTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasCommissionNumberTabs() bool {
	if o != nil && !IsNil(o.CommissionNumberTabs) {
		return true
	}
...
func (o *TemplateTabs) SetCommissionNumberTabs(v []CommissionNumber) {
	o.CommissionNumberTabs = v
}

// GetCommissionStateTabs returns the CommissionStateTabs field value if set, zero value otherwise.
func (o *TemplateTabs) GetCommissionStateTabs() []CommissionState {
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetCommissionStateTabsOk() ([]CommissionState, bool) {
	if o == nil || IsNil(o.CommissionStateTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasCommissionStateTabs() bool {
	if o != nil && !IsNil(o.CommissionStateTabs) {
		return true
	}
...
func (o *TemplateTabs) SetCommissionStateTabs(v []CommissionState) {
	o.CommissionStateTabs = v
}

// GetCompanyTabs returns the CompanyTabs field value if set, zero value otherwise.
func (o *TemplateTabs) GetCompanyTabs() []Company {
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetCompanyTabsOk() ([]Company, bool) {
	if o == nil || IsNil(o.CompanyTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasCompanyTabs() bool {
	if o != nil && !IsNil(o.CompanyTabs) {
		return true
	}
...
func (o *TemplateTabs) SetCompanyTabs(v []Company) {
	o.CompanyTabs = v
}

// GetDateSignedTabs returns the DateSignedTabs field value if set, zero value otherwise.
func (o *TemplateTabs) GetDateSignedTabs() []DateSigned {
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetDateSignedTabsOk() ([]DateSigned, bool) {
	if o == nil || IsNil(o.DateSignedTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasDateSignedTabs() bool {
	if o != nil && !IsNil(o.DateSignedTabs) {
		return true
	}
...
func (o *TemplateTabs) SetDateSignedTabs(v []DateSigned) {
	o.DateSignedTabs = v
}

// GetDateTabs returns the DateTabs field value if set, zero value otherwise.
func (o *TemplateTabs) GetDateTabs() []Date {
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetDateTabsOk() ([]Date, bool) {
	if o == nil || IsNil(o.DateTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasDateTabs() bool {
	if o != nil && !IsNil(o.DateTabs) {
		return true
	}
...
func (o *TemplateTabs) SetDateTabs(v []Date) {
	o.DateTabs = v
}

// GetDeclineTabs returns the DeclineTabs field value if set, zero value otherwise.
func (o *TemplateTabs) GetDeclineTabs() []Decline {
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetDeclineTabsOk() ([]Decline, bool) {
	if o == nil || IsNil(o.DeclineTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasDeclineTabs() bool {
	if o != nil && !IsNil(o.DeclineTabs) {
		return true
	}
...
func (o *TemplateTabs) SetDeclineTabs(v []Decline) {
	o.DeclineTabs = v
}

// GetDrawTabs returns the DrawTabs field value if set, zero value otherwise.
func (o *TemplateTabs) GetDrawTabs() []Draw {
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetDrawTabsOk() ([]Draw, bool) {
	if o == nil || IsNil(o.DrawTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasDrawTabs() bool {
	if o != nil && !IsNil(o.DrawTabs) {
		return true
	}
...
func (o *TemplateTabs) SetDrawTabs(v []Draw) {
	o.DrawTabs = v
}

// GetEmailAddressTabs returns the EmailAddressTabs field value if set, zero value otherwise.
func (o *TemplateTabs) GetEmailAddressTabs() []EmailAddress {
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetEmailAddressTabsOk() ([]EmailAddress, bool) {
	if o == nil || IsNil(o.EmailAddressTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasEmailAddressTabs() bool {
	if o != nil && !IsNil(o.EmailAddressTabs) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetEmailTabsOk() ([]Email, bool) {
	if o == nil || IsNil(o.EmailTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasEmailTabs() bool {
	if o != nil && !IsNil(o.EmailTabs) {
		return true
	}
...
func (o *TemplateTabs) SetEmailTabs(v []Email) {
	o.EmailTabs = v
}

// GetEnvelopeIdTabs returns the EnvelopeIdTabs field value if set, zero value otherwise.
func (o *TemplateTabs) GetEnvelopeIdTabs() []EnvelopeId {
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetEnvelopeIdTabsOk() ([]EnvelopeId, bool) {
	if o == nil || IsNil(o.EnvelopeIdTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasEnvelopeIdTabs() bool {
	if o != nil && !IsNil(o.EnvelopeIdTabs) {
		return true
	}
...
func (o *TemplateTabs) SetEnvelopeIdTabs(v []EnvelopeId) {
	o.EnvelopeIdTabs = v
}

// GetFirstNameTabs returns the FirstNameTabs field value if set, zero value otherwise.
func (o *TemplateTabs) GetFirstNameTabs() []FirstName {
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetFirstNameTabsOk() ([]FirstName, bool) {
	if o == nil || IsNil(o.FirstNameTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasFirstNameTabs() bool {
	if o != nil && !IsNil(o.FirstNameTabs) {
		return true
	}
...
func (o *TemplateTabs) SetFirstNameTabs(v []FirstName) {
	o.FirstNameTabs = v
}

// GetFormulaTabs returns the FormulaTabs field value if set, zero value otherwise.
func (o *TemplateTabs) GetFormulaTabs() []FormulaTab {
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetFormulaTabsOk() ([]FormulaTab, bool) {
	if o == nil || IsNil(o.FormulaTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasFormulaTabs() bool {
	if o != nil && !IsNil(o.FormulaTabs) {
		return true
	}
...
func (o *TemplateTabs) SetFormulaTabs(v []FormulaTab) {
	o.FormulaTabs = v
}

// GetFullNameTabs returns the FullNameTabs field value if set, zero value otherwise.
func (o *TemplateTabs) GetFullNameTabs() []FullName {
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetFullNameTabsOk() ([]FullName, bool) {
	if o == nil || IsNil(o.FullNameTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasFullNameTabs() bool {
	if o != nil && !IsNil(o.FullNameTabs) {
		return true
	}
...
func (o *TemplateTabs) SetFullNameTabs(v []FullName) {
	o.FullNameTabs = v
}

// GetInitialHereTabs returns the InitialHereTabs field value if set, zero value otherwise.
func (o *TemplateTabs) GetInitialHereTabs() []InitialHere {
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetInitialHereTabsOk() ([]InitialHere, bool) {
	if o == nil || IsNil(o.InitialHereTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasInitialHereTabs() bool {
	if o != nil && !IsNil(o.InitialHereTabs) {
		return true
	}
...
func (o *TemplateTabs) SetInitialHereTabs(v []InitialHere) {
	o.InitialHereTabs = v
}

// GetLastNameTabs returns the LastNameTabs field value if set, zero value otherwise.
func (o *TemplateTabs) GetLastNameTabs() []LastName {
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetLastNameTabsOk() ([]LastName, bool) {
	if o == nil || IsNil(o.LastNameTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasLastNameTabs() bool {
	if o != nil && !IsNil(o.LastNameTabs) {
		return true
	}
...
func (o *TemplateTabs) SetLastNameTabs(v []LastName) {
	o.LastNameTabs = v
}

// GetListTabs returns the ListTabs field value if set, zero value otherwise.
func (o *TemplateTabs) GetListTabs() []List {
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetListTabsOk() ([]List, bool) {
	if o == nil || IsNil(o.ListTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasListTabs() bool {
	if o != nil && !IsNil(o.ListTabs) {
		return true
	}
...
func (o *TemplateTabs) SetListTabs(v []List) {
	o.ListTabs = v
}

// GetNotarizeTabs returns the NotarizeTabs field value if set, zero value otherwise.
func (o *TemplateTabs) GetNotarizeTabs() []Notarize {
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetNotarizeTabsOk() ([]Notarize, bool) {
	if o == nil || IsNil(o.NotarizeTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasNotarizeTabs() bool {
	if o != nil && !IsNil(o.NotarizeTabs) {
		return true
	}
...
func (o *TemplateTabs) SetNotarizeTabs(v []Notarize) {
	o.NotarizeTabs = v
}

// GetNotarySealTabs returns the NotarySealTabs field value if set, zero value otherwise.
func (o *TemplateTabs) GetNotarySealTabs() []NotarySeal {
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetNotarySealTabsOk() ([]NotarySeal, bool) {
	if o == nil || IsNil(o.NotarySealTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasNotarySealTabs() bool {
	if o != nil && !IsNil(o.NotarySealTabs) {
		return true
	}
...
func (o *TemplateTabs) SetNotarySealTabs(v []NotarySeal) {
	o.NotarySealTabs = v
}

// GetNoteTabs returns the NoteTabs field value if set, zero value otherwise.
func (o *TemplateTabs) GetNoteTabs() []Note {
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetNoteTabsOk() ([]Note, bool) {
	if o == nil || IsNil(o.NoteTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasNoteTabs() bool {
	if o != nil && !IsNil(o.NoteTabs) {
		return true
	}
...
func (o *TemplateTabs) SetNoteTabs(v []Note) {
	o.NoteTabs = v
}

// GetNumberTabs returns the NumberTabs field value if set, zero value otherwise.
func (o *TemplateTabs) GetNumberTabs() []Number {
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetNumberTabsOk() ([]Number, bool) {
	if o == nil || IsNil(o.NumberTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasNumberTabs() bool {
	if o != nil && !IsNil(o.NumberTabs) {
		return true
	}
...
func (o *TemplateTabs) SetNumberTabs(v []Number) {
	o.NumberTabs = v
}

// GetNumericalTabs returns the NumericalTabs field value if set, zero value otherwise.
func (o *TemplateTabs) GetNumericalTabs() []Numerical {
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetNumericalTabsOk() ([]Numerical, bool) {
	if o == nil || IsNil(o.NumericalTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasNumericalTabs() bool {
	if o != nil && !IsNil(o.NumericalTabs) {
		return true
	}
...
func (o *TemplateTabs) SetNumericalTabs(v []Numerical) {
	o.NumericalTabs = v
}

// GetPhoneNumberTabs returns the PhoneNumberTabs field value if set, zero value otherwise.
func (o *TemplateTabs) GetPhoneNumberTabs() []PhoneNumber {
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetPhoneNumberTabsOk() ([]PhoneNumber, bool) {
	if o == nil || IsNil(o.PhoneNumberTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasPhoneNumberTabs() bool {
	if o != nil && !IsNil(o.PhoneNumberTabs) {
		return true
	}
...
func (o *TemplateTabs) SetPhoneNumberTabs(v []PhoneNumber) {
	o.PhoneNumberTabs = v
}

// GetPolyLineOverlayTabs returns the PolyLineOverlayTabs field value if set, zero value otherwise.
func (o *TemplateTabs) GetPolyLineOverlayTabs() []PolyLineOverlay {
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetPolyLineOverlayTabsOk() ([]PolyLineOverlay, bool) {
	if o == nil || IsNil(o.PolyLineOverlayTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasPolyLineOverlayTabs() bool {
	if o != nil && !IsNil(o.PolyLineOverlayTabs) {
		return true
	}
...
func (o *TemplateTabs) SetPolyLineOverlayTabs(v []PolyLineOverlay) {
	o.PolyLineOverlayTabs = v
}

// GetPrefillTabs returns the PrefillTabs field value if set, zero value otherwise.
func (o *TemplateTabs) GetPrefillTabs() PrefillTabs {
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetPrefillTabsOk() (*PrefillTabs, bool) {
	if o == nil || IsNil(o.PrefillTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasPrefillTabs() bool {
	if o != nil && !IsNil(o.PrefillTabs) {
		return true
	}
...
func (o *TemplateTabs) SetPrefillTabs(v PrefillTabs) {
	o.PrefillTabs = &v
}

// GetRadioGroupTabs returns the RadioGroupTabs field value if set, zero value otherwise.
func (o *TemplateTabs) GetRadioGroupTabs() []RadioGroup {
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetRadioGroupTabsOk() ([]RadioGroup, bool) {
	if o == nil || IsNil(o.RadioGroupTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasRadioGroupTabs() bool {
	if o != nil && !IsNil(o.RadioGroupTabs) {
		return true
	}
...
func (o *TemplateTabs) SetRadioGroupTabs(v []RadioGroup) {
	o.RadioGroupTabs = v
}

// GetSignerAttachmentTabs returns the SignerAttachmentTabs field value if set, zero value otherwise.
func (o *TemplateTabs) GetSignerAttachmentTabs() []SignerAttachment {
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetSignerAttachmentTabsOk() ([]SignerAttachment, bool) {
	if o == nil || IsNil(o.SignerAttachmentTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasSignerAttachmentTabs() bool {
	if o != nil && !IsNil(o.SignerAttachmentTabs) {
		return true
	}
...
func (o *TemplateTabs) SetSignerAttachmentTabs(v []SignerAttachment) {
	o.SignerAttachmentTabs = v
}

// GetSignHereTabs returns the SignHereTabs field value if set, zero value otherwise.
func (o *TemplateTabs) GetSignHereTabs() []SignHere {
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetSignHereTabsOk() ([]SignHere, bool) {
	if o == nil || IsNil(o.SignHereTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasSignHereTabs() bool {
	if o != nil && !IsNil(o.SignHereTabs) {
		return true
	}
...
func (o *TemplateTabs) SetSignHereTabs(v []SignHere) {
	o.SignHereTabs = v
}

// GetSmartSectionTabs returns the SmartSectionTabs field value if set, zero value otherwise.
func (o *TemplateTabs) GetSmartSectionTabs() []SmartSection {
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetSmartSectionTabsOk() ([]SmartSection, bool) {
	if o == nil || IsNil(o.SmartSectionTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasSmartSectionTabs() bool {
	if o != nil && !IsNil(o.SmartSectionTabs) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetSsnTabsOk() ([]Ssn, bool) {
	if o == nil || IsNil(o.SsnTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasSsnTabs() bool {
	if o != nil && !IsNil(o.SsnTabs) {
		return true
	}
...
func (o *TemplateTabs) SetSsnTabs(v []Ssn) {
	o.SsnTabs = v
}

// GetTabGroups returns the TabGroups field value if set, zero value otherwise.
func (o *TemplateTabs) GetTabGroups() []TabGroup {
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetTabGroupsOk() ([]TabGroup, bool) {
	if o == nil || IsNil(o.TabGroups) {
		return nil, false
	}
...
func (o *TemplateTabs) HasTabGroups() bool {
	if o != nil && !IsNil(o.TabGroups) {
		return true
	}
...
func (o *TemplateTabs) SetTabGroups(v []TabGroup) {
	o.TabGroups = v
}

// GetTextTabs returns the TextTabs field value if set, zero value otherwise.
func (o *TemplateTabs) GetTextTabs() []Text {
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetTextTabsOk() ([]Text, bool) {
	if o == nil || IsNil(o.TextTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasTextTabs() bool {
	if o != nil && !IsNil(o.TextTabs) {
		return true
	}
...
func (o *TemplateTabs) SetTextTabs(v []Text) {
	o.TextTabs = v
}

// GetTitleTabs returns the TitleTabs field value if set, zero value otherwise.
func (o *TemplateTabs) GetTitleTabs() []Title {
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetTitleTabsOk() ([]Title, bool) {
	if o == nil || IsNil(o.TitleTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasTitleTabs() bool {
	if o != nil && !IsNil(o.TitleTabs) {
		return true
	}
...
func (o *TemplateTabs) SetTitleTabs(v []Title) {
	o.TitleTabs = v
}

// GetViewTabs returns the ViewTabs field value if set, zero value otherwise.
func (o *TemplateTabs) GetViewTabs() []View {
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetViewTabsOk() ([]View, bool) {
	if o == nil || IsNil(o.ViewTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasViewTabs() bool {
	if o != nil && !IsNil(o.ViewTabs) {
		return true
	}
...
func (o *TemplateTabs) SetViewTabs(v []View) {
	o.ViewTabs = v
}

// GetZipTabs returns the ZipTabs field value if set, zero value otherwise.
func (o *TemplateTabs) GetZipTabs() []Zip {
...
// and a boolean to check if the value has been set.
func (o *TemplateTabs) GetZipTabsOk() ([]Zip, bool) {
	if o == nil || IsNil(o.ZipTabs) {
		return nil, false
	}
...
func (o *TemplateTabs) HasZipTabs() bool {
	if o != nil && !IsNil(o.ZipTabs) {
		return true
	}
...
func (o *TemplateTabs) SetZipTabs(v []Zip) {
	o.ZipTabs = v
}

func (o TemplateTabs) MarshalJSON() ([]byte, error) {
...
func (o TemplateTabs) ToMap() (map[string]interface{}, error) {
...
type NullableTemplateTabs struct {
	value *TemplateTabs
	isSet bool
}

func (v NullableTemplateTabs) Get() *TemplateTabs {
	return v.value
}

func (v *NullableTemplateTabs) Set(val *TemplateTabs) {
	v.value = val
	v.isSet = true
}

func (v NullableTemplateTabs) IsSet() bool {
	return v.isSet
}

func (v *NullableTemplateTabs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTemplateTabs(val *TemplateTabs) *NullableTemplateTabs {
	return &NullableTemplateTabs{value: val, isSet: true}
}

func (v NullableTemplateTabs) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTemplateTabs) UnmarshalJSON(src []byte) error {
	v.isSet = true
