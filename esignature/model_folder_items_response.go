...
// checks if the FolderItemsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FolderItemsResponse{}
...
// NewFolderItemsResponse instantiates a new FolderItemsResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewFolderItemsResponse() *FolderItemsResponse {
	this := FolderItemsResponse{}
	return &this
}

// NewFolderItemsResponseWithDefaults instantiates a new FolderItemsResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewFolderItemsResponseWithDefaults() *FolderItemsResponse {
	this := FolderItemsResponse{}
	return &this
}

// GetEndPosition returns the EndPosition field value if set, zero value otherwise.
func (o *FolderItemsResponse) GetEndPosition() string {
...
func (o *FolderItemsResponse) GetEndPositionOk() (*string, bool) {
	if o == nil || IsNil(o.EndPosition) {
		return nil, false
	}
...
func (o *FolderItemsResponse) HasEndPosition() bool {
	if o != nil && !IsNil(o.EndPosition) {
		return true
	}
...
func (o *FolderItemsResponse) SetEndPosition(v string) {
	o.EndPosition = &v
}

// GetEnvelopes returns the Envelopes field value if set, zero value otherwise.
func (o *FolderItemsResponse) GetEnvelopes() []EnvelopeSummary {
...
// and a boolean to check if the value has been set.
func (o *FolderItemsResponse) GetEnvelopesOk() ([]EnvelopeSummary, bool) {
	if o == nil || IsNil(o.Envelopes) {
		return nil, false
	}
...
func (o *FolderItemsResponse) HasEnvelopes() bool {
	if o != nil && !IsNil(o.Envelopes) {
		return true
	}
...
func (o *FolderItemsResponse) SetEnvelopes(v []EnvelopeSummary) {
	o.Envelopes = v
}

// GetFolders returns the Folders field value if set, zero value otherwise.
func (o *FolderItemsResponse) GetFolders() []Folder {
...
// and a boolean to check if the value has been set.
func (o *FolderItemsResponse) GetFoldersOk() ([]Folder, bool) {
	if o == nil || IsNil(o.Folders) {
		return nil, false
	}
...
func (o *FolderItemsResponse) HasFolders() bool {
	if o != nil && !IsNil(o.Folders) {
		return true
	}
...
func (o *FolderItemsResponse) SetFolders(v []Folder) {
	o.Folders = v
}

// GetNextUri returns the NextUri field value if set, zero value otherwise.
func (o *FolderItemsResponse) GetNextUri() string {
...
// and a boolean to check if the value has been set.
func (o *FolderItemsResponse) GetNextUriOk() (*string, bool) {
	if o == nil || IsNil(o.NextUri) {
		return nil, false
	}
...
func (o *FolderItemsResponse) HasNextUri() bool {
	if o != nil && !IsNil(o.NextUri) {
		return true
	}
...
func (o *FolderItemsResponse) SetNextUri(v string) {
	o.NextUri = &v
}

// GetPreviousUri returns the PreviousUri field value if set, zero value otherwise.
func (o *FolderItemsResponse) GetPreviousUri() string {
...
// and a boolean to check if the value has been set.
func (o *FolderItemsResponse) GetPreviousUriOk() (*string, bool) {
	if o == nil || IsNil(o.PreviousUri) {
		return nil, false
	}
...
func (o *FolderItemsResponse) HasPreviousUri() bool {
	if o != nil && !IsNil(o.PreviousUri) {
		return true
	}
...
func (o *FolderItemsResponse) SetPreviousUri(v string) {
	o.PreviousUri = &v
}

// GetResultSetSize returns the ResultSetSize field value if set, zero value otherwise.
func (o *FolderItemsResponse) GetResultSetSize() string {
...
// and a boolean to check if the value has been set.
func (o *FolderItemsResponse) GetResultSetSizeOk() (*string, bool) {
	if o == nil || IsNil(o.ResultSetSize) {
		return nil, false
	}
...
func (o *FolderItemsResponse) HasResultSetSize() bool {
	if o != nil && !IsNil(o.ResultSetSize) {
		return true
	}
...
func (o *FolderItemsResponse) SetResultSetSize(v string) {
	o.ResultSetSize = &v
}

// GetStartPosition returns the StartPosition field value if set, zero value otherwise.
func (o *FolderItemsResponse) GetStartPosition() string {
...
// and a boolean to check if the value has been set.
func (o *FolderItemsResponse) GetStartPositionOk() (*string, bool) {
	if o == nil || IsNil(o.StartPosition) {
		return nil, false
	}
...
func (o *FolderItemsResponse) HasStartPosition() bool {
	if o != nil && !IsNil(o.StartPosition) {
		return true
	}
...
func (o *FolderItemsResponse) SetStartPosition(v string) {
	o.StartPosition = &v
}

// GetTotalSetSize returns the TotalSetSize field value if set, zero value otherwise.
func (o *FolderItemsResponse) GetTotalSetSize() string {
...
// and a boolean to check if the value has been set.
func (o *FolderItemsResponse) GetTotalSetSizeOk() (*string, bool) {
	if o == nil || IsNil(o.TotalSetSize) {
		return nil, false
	}
...
func (o *FolderItemsResponse) HasTotalSetSize() bool {
	if o != nil && !IsNil(o.TotalSetSize) {
		return true
	}
...
func (o *FolderItemsResponse) SetTotalSetSize(v string) {
	o.TotalSetSize = &v
}

func (o FolderItemsResponse) MarshalJSON() ([]byte, error) {
...
func (o FolderItemsResponse) ToMap() (map[string]interface{}, error) {
...
type NullableFolderItemsResponse struct {
	value *FolderItemsResponse
	isSet bool
}

func (v NullableFolderItemsResponse) Get() *FolderItemsResponse {
	return v.value
}

func (v *NullableFolderItemsResponse) Set(val *FolderItemsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFolderItemsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFolderItemsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFolderItemsResponse(val *FolderItemsResponse) *NullableFolderItemsResponse {
	return &NullableFolderItemsResponse{value: val, isSet: true}
}

func (v NullableFolderItemsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFolderItemsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
