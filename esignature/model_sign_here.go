...
// checks if the SignHere type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SignHere{}

// SignHere A tab that allows the recipient to sign a document. May be optional. 
type SignHere struct {
	...
	// This property indicates the horizontal offset of the object on the page. DocuSign uses 72 DPI when determining position. Required. Must be an integer. May be zero.  To improve the tab's position on the document, DocuSign recommends adjusting `xPosition` and `yPosition` coordinates by (+1, -7) 
	XPosition *string `json:"xPosition,omitempty"`
	XPositionMetadata *PropertyMetadata `json:"xPositionMetadata,omitempty"`
	// This property indicates the vertical offset of the object on the page. DocuSign uses 72 DPI when determining position. Required. Must be an integer. May be zero.  To improve the tab's position on the document, DocuSign recommends adjusting `xPosition` and `yPosition` coordinates by (+1, -7) 
	YPosition *string `json:"yPosition,omitempty"`
	YPositionMetadata *PropertyMetadata `json:"yPositionMetadata,omitempty"`
}

// NewSignHere instantiates a new SignHere object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewSignHere() *SignHere {
	this := SignHere{}
	return &this
}

// NewSignHereWithDefaults instantiates a new SignHere object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewSignHereWithDefaults() *SignHere {
	this := SignHere{}
	return &this
}
...
func (o *SignHere) GetAnchorAllowWhiteSpaceInCharacters() string {
...
func (o *SignHere) GetAnchorAllowWhiteSpaceInCharactersOk() (*string, bool) {
	if o == nil || IsNil(o.AnchorAllowWhiteSpaceInCharacters) {
		return nil, false
	}
...
func (o *SignHere) HasAnchorAllowWhiteSpaceInCharacters() bool {
	if o != nil && !IsNil(o.AnchorAllowWhiteSpaceInCharacters) {
		return true
	}
...
func (o *SignHere) SetAnchorAllowWhiteSpaceInCharacters(v string) {
...
func (o *SignHere) GetAnchorAllowWhiteSpaceInCharactersMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetAnchorAllowWhiteSpaceInCharactersMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.AnchorAllowWhiteSpaceInCharactersMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasAnchorAllowWhiteSpaceInCharactersMetadata() bool {
	if o != nil && !IsNil(o.AnchorAllowWhiteSpaceInCharactersMetadata) {
		return true
	}
...
func (o *SignHere) SetAnchorAllowWhiteSpaceInCharactersMetadata(v PropertyMetadata) {
...
func (o *SignHere) GetAnchorCaseSensitive() string {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetAnchorCaseSensitiveOk() (*string, bool) {
	if o == nil || IsNil(o.AnchorCaseSensitive) {
		return nil, false
	}
...
func (o *SignHere) HasAnchorCaseSensitive() bool {
	if o != nil && !IsNil(o.AnchorCaseSensitive) {
		return true
	}
...
func (o *SignHere) SetAnchorCaseSensitive(v string) {
...
func (o *SignHere) GetAnchorCaseSensitiveMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetAnchorCaseSensitiveMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.AnchorCaseSensitiveMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasAnchorCaseSensitiveMetadata() bool {
	if o != nil && !IsNil(o.AnchorCaseSensitiveMetadata) {
		return true
	}
...
func (o *SignHere) SetAnchorCaseSensitiveMetadata(v PropertyMetadata) {
...
func (o *SignHere) GetAnchorHorizontalAlignment() string {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetAnchorHorizontalAlignmentOk() (*string, bool) {
	if o == nil || IsNil(o.AnchorHorizontalAlignment) {
		return nil, false
	}
...
func (o *SignHere) HasAnchorHorizontalAlignment() bool {
	if o != nil && !IsNil(o.AnchorHorizontalAlignment) {
		return true
	}
...
func (o *SignHere) SetAnchorHorizontalAlignment(v string) {
...
func (o *SignHere) GetAnchorHorizontalAlignmentMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetAnchorHorizontalAlignmentMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.AnchorHorizontalAlignmentMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasAnchorHorizontalAlignmentMetadata() bool {
	if o != nil && !IsNil(o.AnchorHorizontalAlignmentMetadata) {
		return true
	}
...
func (o *SignHere) SetAnchorHorizontalAlignmentMetadata(v PropertyMetadata) {
...
func (o *SignHere) GetAnchorIgnoreIfNotPresent() string {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetAnchorIgnoreIfNotPresentOk() (*string, bool) {
	if o == nil || IsNil(o.AnchorIgnoreIfNotPresent) {
		return nil, false
	}
...
func (o *SignHere) HasAnchorIgnoreIfNotPresent() bool {
	if o != nil && !IsNil(o.AnchorIgnoreIfNotPresent) {
		return true
	}
...
func (o *SignHere) SetAnchorIgnoreIfNotPresent(v string) {
...
func (o *SignHere) GetAnchorIgnoreIfNotPresentMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetAnchorIgnoreIfNotPresentMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.AnchorIgnoreIfNotPresentMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasAnchorIgnoreIfNotPresentMetadata() bool {
	if o != nil && !IsNil(o.AnchorIgnoreIfNotPresentMetadata) {
		return true
	}
...
func (o *SignHere) SetAnchorIgnoreIfNotPresentMetadata(v PropertyMetadata) {
...
func (o *SignHere) GetAnchorMatchWholeWord() string {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetAnchorMatchWholeWordOk() (*string, bool) {
	if o == nil || IsNil(o.AnchorMatchWholeWord) {
		return nil, false
	}
...
func (o *SignHere) HasAnchorMatchWholeWord() bool {
	if o != nil && !IsNil(o.AnchorMatchWholeWord) {
		return true
	}
...
func (o *SignHere) SetAnchorMatchWholeWord(v string) {
...
func (o *SignHere) GetAnchorMatchWholeWordMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetAnchorMatchWholeWordMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.AnchorMatchWholeWordMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasAnchorMatchWholeWordMetadata() bool {
	if o != nil && !IsNil(o.AnchorMatchWholeWordMetadata) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetAnchorStringOk() (*string, bool) {
	if o == nil || IsNil(o.AnchorString) {
		return nil, false
	}
...
func (o *SignHere) HasAnchorString() bool {
	if o != nil && !IsNil(o.AnchorString) {
		return true
	}
...
func (o *SignHere) SetAnchorString(v string) {
	o.AnchorString = &v
}

// GetAnchorStringMetadata returns the AnchorStringMetadata field value if set, zero value otherwise.
func (o *SignHere) GetAnchorStringMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetAnchorStringMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.AnchorStringMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasAnchorStringMetadata() bool {
	if o != nil && !IsNil(o.AnchorStringMetadata) {
		return true
	}
...
func (o *SignHere) SetAnchorStringMetadata(v PropertyMetadata) {
...
func (o *SignHere) GetAnchorTabProcessorVersion() string {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetAnchorTabProcessorVersionOk() (*string, bool) {
	if o == nil || IsNil(o.AnchorTabProcessorVersion) {
		return nil, false
	}
...
func (o *SignHere) HasAnchorTabProcessorVersion() bool {
	if o != nil && !IsNil(o.AnchorTabProcessorVersion) {
		return true
	}
...
func (o *SignHere) SetAnchorTabProcessorVersion(v string) {
...
func (o *SignHere) GetAnchorTabProcessorVersionMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetAnchorTabProcessorVersionMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.AnchorTabProcessorVersionMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasAnchorTabProcessorVersionMetadata() bool {
	if o != nil && !IsNil(o.AnchorTabProcessorVersionMetadata) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetAnchorUnitsOk() (*string, bool) {
	if o == nil || IsNil(o.AnchorUnits) {
		return nil, false
	}
...
func (o *SignHere) HasAnchorUnits() bool {
	if o != nil && !IsNil(o.AnchorUnits) {
		return true
	}
...
func (o *SignHere) SetAnchorUnits(v string) {
	o.AnchorUnits = &v
}

// GetAnchorUnitsMetadata returns the AnchorUnitsMetadata field value if set, zero value otherwise.
func (o *SignHere) GetAnchorUnitsMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetAnchorUnitsMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.AnchorUnitsMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasAnchorUnitsMetadata() bool {
	if o != nil && !IsNil(o.AnchorUnitsMetadata) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetAnchorXOffsetOk() (*string, bool) {
	if o == nil || IsNil(o.AnchorXOffset) {
		return nil, false
	}
...
func (o *SignHere) HasAnchorXOffset() bool {
	if o != nil && !IsNil(o.AnchorXOffset) {
		return true
	}
...
func (o *SignHere) SetAnchorXOffset(v string) {
	o.AnchorXOffset = &v
}

// GetAnchorXOffsetMetadata returns the AnchorXOffsetMetadata field value if set, zero value otherwise.
func (o *SignHere) GetAnchorXOffsetMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetAnchorXOffsetMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.AnchorXOffsetMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasAnchorXOffsetMetadata() bool {
	if o != nil && !IsNil(o.AnchorXOffsetMetadata) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetAnchorYOffsetOk() (*string, bool) {
	if o == nil || IsNil(o.AnchorYOffset) {
		return nil, false
	}
...
func (o *SignHere) HasAnchorYOffset() bool {
	if o != nil && !IsNil(o.AnchorYOffset) {
		return true
	}
...
func (o *SignHere) SetAnchorYOffset(v string) {
	o.AnchorYOffset = &v
}

// GetAnchorYOffsetMetadata returns the AnchorYOffsetMetadata field value if set, zero value otherwise.
func (o *SignHere) GetAnchorYOffsetMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetAnchorYOffsetMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.AnchorYOffsetMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasAnchorYOffsetMetadata() bool {
	if o != nil && !IsNil(o.AnchorYOffsetMetadata) {
		return true
	}
...
func (o *SignHere) SetAnchorYOffsetMetadata(v PropertyMetadata) {
	o.AnchorYOffsetMetadata = &v
}

// GetCaption returns the Caption field value if set, zero value otherwise.
func (o *SignHere) GetCaption() string {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetCaptionOk() (*string, bool) {
	if o == nil || IsNil(o.Caption) {
		return nil, false
	}
...
func (o *SignHere) HasCaption() bool {
	if o != nil && !IsNil(o.Caption) {
		return true
	}
...
func (o *SignHere) SetCaption(v string) {
	o.Caption = &v
}

// GetCaptionMetadata returns the CaptionMetadata field value if set, zero value otherwise.
func (o *SignHere) GetCaptionMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetCaptionMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.CaptionMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasCaptionMetadata() bool {
	if o != nil && !IsNil(o.CaptionMetadata) {
		return true
	}
...
func (o *SignHere) SetCaptionMetadata(v PropertyMetadata) {
	o.CaptionMetadata = &v
}

// GetConditionalParentLabel returns the ConditionalParentLabel field value if set, zero value otherwise.
func (o *SignHere) GetConditionalParentLabel() string {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetConditionalParentLabelOk() (*string, bool) {
	if o == nil || IsNil(o.ConditionalParentLabel) {
		return nil, false
	}
...
func (o *SignHere) HasConditionalParentLabel() bool {
	if o != nil && !IsNil(o.ConditionalParentLabel) {
		return true
	}
...
func (o *SignHere) SetConditionalParentLabel(v string) {
...
func (o *SignHere) GetConditionalParentLabelMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetConditionalParentLabelMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.ConditionalParentLabelMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasConditionalParentLabelMetadata() bool {
	if o != nil && !IsNil(o.ConditionalParentLabelMetadata) {
		return true
	}
...
func (o *SignHere) SetConditionalParentLabelMetadata(v PropertyMetadata) {
...
func (o *SignHere) GetConditionalParentValue() string {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetConditionalParentValueOk() (*string, bool) {
	if o == nil || IsNil(o.ConditionalParentValue) {
		return nil, false
	}
...
func (o *SignHere) HasConditionalParentValue() bool {
	if o != nil && !IsNil(o.ConditionalParentValue) {
		return true
	}
...
func (o *SignHere) SetConditionalParentValue(v string) {
...
func (o *SignHere) GetConditionalParentValueMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetConditionalParentValueMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.ConditionalParentValueMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasConditionalParentValueMetadata() bool {
	if o != nil && !IsNil(o.ConditionalParentValueMetadata) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetCustomTabIdOk() (*string, bool) {
	if o == nil || IsNil(o.CustomTabId) {
		return nil, false
	}
...
func (o *SignHere) HasCustomTabId() bool {
	if o != nil && !IsNil(o.CustomTabId) {
		return true
	}
...
func (o *SignHere) SetCustomTabId(v string) {
	o.CustomTabId = &v
}

// GetCustomTabIdMetadata returns the CustomTabIdMetadata field value if set, zero value otherwise.
func (o *SignHere) GetCustomTabIdMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetCustomTabIdMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.CustomTabIdMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasCustomTabIdMetadata() bool {
	if o != nil && !IsNil(o.CustomTabIdMetadata) {
		return true
	}
...
func (o *SignHere) SetCustomTabIdMetadata(v PropertyMetadata) {
	o.CustomTabIdMetadata = &v
}

// GetDocumentId returns the DocumentId field value if set, zero value otherwise.
func (o *SignHere) GetDocumentId() string {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetDocumentIdOk() (*string, bool) {
	if o == nil || IsNil(o.DocumentId) {
		return nil, false
	}
...
func (o *SignHere) HasDocumentId() bool {
	if o != nil && !IsNil(o.DocumentId) {
		return true
	}
...
func (o *SignHere) SetDocumentId(v string) {
	o.DocumentId = &v
}

// GetDocumentIdMetadata returns the DocumentIdMetadata field value if set, zero value otherwise.
func (o *SignHere) GetDocumentIdMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetDocumentIdMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.DocumentIdMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasDocumentIdMetadata() bool {
	if o != nil && !IsNil(o.DocumentIdMetadata) {
		return true
	}
...
func (o *SignHere) SetDocumentIdMetadata(v PropertyMetadata) {
	o.DocumentIdMetadata = &v
}

// GetErrorDetails returns the ErrorDetails field value if set, zero value otherwise.
func (o *SignHere) GetErrorDetails() ErrorDetails {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetErrorDetailsOk() (*ErrorDetails, bool) {
	if o == nil || IsNil(o.ErrorDetails) {
		return nil, false
	}
...
func (o *SignHere) HasErrorDetails() bool {
	if o != nil && !IsNil(o.ErrorDetails) {
		return true
	}
...
func (o *SignHere) SetErrorDetails(v ErrorDetails) {
	o.ErrorDetails = &v
}

// GetFormOrder returns the FormOrder field value if set, zero value otherwise.
func (o *SignHere) GetFormOrder() string {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetFormOrderOk() (*string, bool) {
	if o == nil || IsNil(o.FormOrder) {
		return nil, false
	}
...
func (o *SignHere) HasFormOrder() bool {
	if o != nil && !IsNil(o.FormOrder) {
		return true
	}
...
func (o *SignHere) SetFormOrder(v string) {
	o.FormOrder = &v
}

// GetFormOrderMetadata returns the FormOrderMetadata field value if set, zero value otherwise.
func (o *SignHere) GetFormOrderMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetFormOrderMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.FormOrderMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasFormOrderMetadata() bool {
	if o != nil && !IsNil(o.FormOrderMetadata) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetFormPageLabelOk() (*string, bool) {
	if o == nil || IsNil(o.FormPageLabel) {
		return nil, false
	}
...
func (o *SignHere) HasFormPageLabel() bool {
	if o != nil && !IsNil(o.FormPageLabel) {
		return true
	}
...
func (o *SignHere) SetFormPageLabel(v string) {
	o.FormPageLabel = &v
}

// GetFormPageLabelMetadata returns the FormPageLabelMetadata field value if set, zero value otherwise.
func (o *SignHere) GetFormPageLabelMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetFormPageLabelMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.FormPageLabelMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasFormPageLabelMetadata() bool {
	if o != nil && !IsNil(o.FormPageLabelMetadata) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetFormPageNumberOk() (*string, bool) {
	if o == nil || IsNil(o.FormPageNumber) {
		return nil, false
	}
...
func (o *SignHere) HasFormPageNumber() bool {
	if o != nil && !IsNil(o.FormPageNumber) {
		return true
	}
...
func (o *SignHere) SetFormPageNumber(v string) {
	o.FormPageNumber = &v
}

// GetFormPageNumberMetadata returns the FormPageNumberMetadata field value if set, zero value otherwise.
func (o *SignHere) GetFormPageNumberMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetFormPageNumberMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.FormPageNumberMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasFormPageNumberMetadata() bool {
	if o != nil && !IsNil(o.FormPageNumberMetadata) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetHandDrawRequiredOk() (*string, bool) {
	if o == nil || IsNil(o.HandDrawRequired) {
		return nil, false
	}
...
func (o *SignHere) HasHandDrawRequired() bool {
	if o != nil && !IsNil(o.HandDrawRequired) {
		return true
	}
...
func (o *SignHere) SetHandDrawRequired(v string) {
	o.HandDrawRequired = &v
}

// GetHeight returns the Height field value if set, zero value otherwise.
func (o *SignHere) GetHeight() string {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetHeightOk() (*string, bool) {
	if o == nil || IsNil(o.Height) {
		return nil, false
	}
...
func (o *SignHere) HasHeight() bool {
	if o != nil && !IsNil(o.Height) {
		return true
	}
...
func (o *SignHere) SetHeight(v string) {
	o.Height = &v
}

// GetHeightMetadata returns the HeightMetadata field value if set, zero value otherwise.
func (o *SignHere) GetHeightMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetHeightMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.HeightMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasHeightMetadata() bool {
	if o != nil && !IsNil(o.HeightMetadata) {
		return true
	}
...
func (o *SignHere) SetHeightMetadata(v PropertyMetadata) {
	o.HeightMetadata = &v
}

// GetIsSealSignTab returns the IsSealSignTab field value if set, zero value otherwise.
func (o *SignHere) GetIsSealSignTab() string {
	if o == nil || IsNil(o.IsSealSignTab) {
		var ret string
		return ret
	}
	return *o.IsSealSignTab
}

// GetIsSealSignTabOk returns a tuple with the IsSealSignTab field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SignHere) GetIsSealSignTabOk() (*string, bool) {
	if o == nil || IsNil(o.IsSealSignTab) {
		return nil, false
	}
	return o.IsSealSignTab, true
}

// HasIsSealSignTab returns a boolean if a field has been set.
func (o *SignHere) HasIsSealSignTab() bool {
	if o != nil && !IsNil(o.IsSealSignTab) {
		return true
	}
...
// SetIsSealSignTab gets a reference to the given string and assigns it to the IsSealSignTab field.
func (o *SignHere) SetIsSealSignTab(v string) {
	o.IsSealSignTab = &v
}

// GetMergeField returns the MergeField field value if set, zero value otherwise.
func (o *SignHere) GetMergeField() MergeField {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetMergeFieldOk() (*MergeField, bool) {
	if o == nil || IsNil(o.MergeField) {
		return nil, false
	}
...
func (o *SignHere) HasMergeField() bool {
	if o != nil && !IsNil(o.MergeField) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetMergeFieldXmlOk() (*string, bool) {
	if o == nil || IsNil(o.MergeFieldXml) {
		return nil, false
	}
...
func (o *SignHere) HasMergeFieldXml() bool {
	if o != nil && !IsNil(o.MergeFieldXml) {
		return true
	}
...
func (o *SignHere) SetMergeFieldXml(v string) {
	o.MergeFieldXml = &v
}

// GetName returns the Name field value if set, zero value otherwise.
func (o *SignHere) GetName() string {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetNameOk() (*string, bool) {
	if o == nil || IsNil(o.Name) {
		return nil, false
	}
	return o.Name, true
...
func (o *SignHere) SetName(v string) {
	o.Name = &v
}

// GetNameMetadata returns the NameMetadata field value if set, zero value otherwise.
func (o *SignHere) GetNameMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetNameMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.NameMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasNameMetadata() bool {
	if o != nil && !IsNil(o.NameMetadata) {
		return true
	}
...
func (o *SignHere) SetNameMetadata(v PropertyMetadata) {
	o.NameMetadata = &v
}

// GetOptional returns the Optional field value if set, zero value otherwise.
func (o *SignHere) GetOptional() string {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetOptionalOk() (*string, bool) {
	if o == nil || IsNil(o.Optional) {
		return nil, false
	}
...
func (o *SignHere) HasOptional() bool {
	if o != nil && !IsNil(o.Optional) {
		return true
	}
...
func (o *SignHere) SetOptional(v string) {
	o.Optional = &v
}

// GetOptionalMetadata returns the OptionalMetadata field value if set, zero value otherwise.
func (o *SignHere) GetOptionalMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetOptionalMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.OptionalMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasOptionalMetadata() bool {
	if o != nil && !IsNil(o.OptionalMetadata) {
		return true
	}
...
func (o *SignHere) SetOptionalMetadata(v PropertyMetadata) {
	o.OptionalMetadata = &v
}

// GetPageNumber returns the PageNumber field value if set, zero value otherwise.
func (o *SignHere) GetPageNumber() string {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetPageNumberOk() (*string, bool) {
	if o == nil || IsNil(o.PageNumber) {
		return nil, false
	}
...
func (o *SignHere) HasPageNumber() bool {
	if o != nil && !IsNil(o.PageNumber) {
		return true
	}
...
func (o *SignHere) SetPageNumber(v string) {
	o.PageNumber = &v
}

// GetPageNumberMetadata returns the PageNumberMetadata field value if set, zero value otherwise.
func (o *SignHere) GetPageNumberMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetPageNumberMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.PageNumberMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasPageNumberMetadata() bool {
	if o != nil && !IsNil(o.PageNumberMetadata) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetRecipientIdOk() (*string, bool) {
	if o == nil || IsNil(o.RecipientId) {
		return nil, false
	}
...
func (o *SignHere) HasRecipientId() bool {
	if o != nil && !IsNil(o.RecipientId) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetRecipientIdGuidOk() (*string, bool) {
	if o == nil || IsNil(o.RecipientIdGuid) {
		return nil, false
	}
...
func (o *SignHere) HasRecipientIdGuid() bool {
	if o != nil && !IsNil(o.RecipientIdGuid) {
		return true
	}
...
func (o *SignHere) SetRecipientIdGuid(v string) {
	o.RecipientIdGuid = &v
}

// GetRecipientIdGuidMetadata returns the RecipientIdGuidMetadata field value if set, zero value otherwise.
func (o *SignHere) GetRecipientIdGuidMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetRecipientIdGuidMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.RecipientIdGuidMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasRecipientIdGuidMetadata() bool {
	if o != nil && !IsNil(o.RecipientIdGuidMetadata) {
		return true
	}
...
func (o *SignHere) SetRecipientIdGuidMetadata(v PropertyMetadata) {
...
func (o *SignHere) GetRecipientIdMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetRecipientIdMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.RecipientIdMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasRecipientIdMetadata() bool {
	if o != nil && !IsNil(o.RecipientIdMetadata) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetScaleValueOk() (*string, bool) {
	if o == nil || IsNil(o.ScaleValue) {
		return nil, false
	}
...
func (o *SignHere) HasScaleValue() bool {
	if o != nil && !IsNil(o.ScaleValue) {
		return true
	}
...
func (o *SignHere) SetScaleValue(v string) {
	o.ScaleValue = &v
}

// GetScaleValueMetadata returns the ScaleValueMetadata field value if set, zero value otherwise.
func (o *SignHere) GetScaleValueMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetScaleValueMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.ScaleValueMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasScaleValueMetadata() bool {
	if o != nil && !IsNil(o.ScaleValueMetadata) {
		return true
	}
...
func (o *SignHere) SetScaleValueMetadata(v PropertyMetadata) {
...
func (o *SignHere) GetSmartContractInformation() SmartContractInformation {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetSmartContractInformationOk() (*SmartContractInformation, bool) {
	if o == nil || IsNil(o.SmartContractInformation) {
		return nil, false
	}
...
func (o *SignHere) HasSmartContractInformation() bool {
	if o != nil && !IsNil(o.SmartContractInformation) {
		return true
	}
...
func (o *SignHere) SetSmartContractInformation(v SmartContractInformation) {
	o.SmartContractInformation = &v
}

// GetSource returns the Source field value if set, zero value otherwise.
func (o *SignHere) GetSource() string {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetSourceOk() (*string, bool) {
	if o == nil || IsNil(o.Source) {
		return nil, false
	}
...
func (o *SignHere) HasSource() bool {
	if o != nil && !IsNil(o.Source) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetStampOk() (*Stamp, bool) {
	if o == nil || IsNil(o.Stamp) {
		return nil, false
	}
	return o.Stamp, true
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetStampTypeOk() (*string, bool) {
	if o == nil || IsNil(o.StampType) {
		return nil, false
	}
...
func (o *SignHere) HasStampType() bool {
	if o != nil && !IsNil(o.StampType) {
		return true
	}
...
func (o *SignHere) SetStampType(v string) {
	o.StampType = &v
}

// GetStampTypeMetadata returns the StampTypeMetadata field value if set, zero value otherwise.
func (o *SignHere) GetStampTypeMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetStampTypeMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.StampTypeMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasStampTypeMetadata() bool {
	if o != nil && !IsNil(o.StampTypeMetadata) {
		return true
	}
...
func (o *SignHere) SetStampTypeMetadata(v PropertyMetadata) {
	o.StampTypeMetadata = &v
}

// GetStatus returns the Status field value if set, zero value otherwise.
func (o *SignHere) GetStatus() string {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetStatusOk() (*string, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *SignHere) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
...
func (o *SignHere) SetStatus(v string) {
	o.Status = &v
}

// GetStatusMetadata returns the StatusMetadata field value if set, zero value otherwise.
func (o *SignHere) GetStatusMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetStatusMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.StatusMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasStatusMetadata() bool {
	if o != nil && !IsNil(o.StatusMetadata) {
		return true
	}
...
func (o *SignHere) SetStatusMetadata(v PropertyMetadata) {
	o.StatusMetadata = &v
}

// GetTabGroupLabels returns the TabGroupLabels field value if set, zero value otherwise.
func (o *SignHere) GetTabGroupLabels() []string {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetTabGroupLabelsOk() ([]string, bool) {
	if o == nil || IsNil(o.TabGroupLabels) {
		return nil, false
	}
...
func (o *SignHere) HasTabGroupLabels() bool {
	if o != nil && !IsNil(o.TabGroupLabels) {
		return true
	}
...
func (o *SignHere) SetTabGroupLabels(v []string) {
	o.TabGroupLabels = v
}

// GetTabGroupLabelsMetadata returns the TabGroupLabelsMetadata field value if set, zero value otherwise.
func (o *SignHere) GetTabGroupLabelsMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetTabGroupLabelsMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.TabGroupLabelsMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasTabGroupLabelsMetadata() bool {
	if o != nil && !IsNil(o.TabGroupLabelsMetadata) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetTabIdOk() (*string, bool) {
	if o == nil || IsNil(o.TabId) {
		return nil, false
	}
	return o.TabId, true
...
func (o *SignHere) SetTabId(v string) {
	o.TabId = &v
}

// GetTabIdMetadata returns the TabIdMetadata field value if set, zero value otherwise.
func (o *SignHere) GetTabIdMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetTabIdMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.TabIdMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasTabIdMetadata() bool {
	if o != nil && !IsNil(o.TabIdMetadata) {
		return true
	}
...
func (o *SignHere) SetTabIdMetadata(v PropertyMetadata) {
	o.TabIdMetadata = &v
}

// GetTabLabel returns the TabLabel field value if set, zero value otherwise.
func (o *SignHere) GetTabLabel() string {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetTabLabelOk() (*string, bool) {
	if o == nil || IsNil(o.TabLabel) {
		return nil, false
	}
...
func (o *SignHere) HasTabLabel() bool {
	if o != nil && !IsNil(o.TabLabel) {
		return true
	}
...
func (o *SignHere) SetTabLabel(v string) {
	o.TabLabel = &v
}

// GetTabLabelMetadata returns the TabLabelMetadata field value if set, zero value otherwise.
func (o *SignHere) GetTabLabelMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetTabLabelMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.TabLabelMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasTabLabelMetadata() bool {
	if o != nil && !IsNil(o.TabLabelMetadata) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetTabOrderOk() (*string, bool) {
	if o == nil || IsNil(o.TabOrder) {
		return nil, false
	}
...
func (o *SignHere) HasTabOrder() bool {
	if o != nil && !IsNil(o.TabOrder) {
		return true
	}
...
func (o *SignHere) SetTabOrder(v string) {
	o.TabOrder = &v
}

// GetTabOrderMetadata returns the TabOrderMetadata field value if set, zero value otherwise.
func (o *SignHere) GetTabOrderMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetTabOrderMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.TabOrderMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasTabOrderMetadata() bool {
	if o != nil && !IsNil(o.TabOrderMetadata) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetTabTypeOk() (*string, bool) {
	if o == nil || IsNil(o.TabType) {
		return nil, false
	}
...
func (o *SignHere) HasTabType() bool {
	if o != nil && !IsNil(o.TabType) {
		return true
	}
...
func (o *SignHere) SetTabType(v string) {
	o.TabType = &v
}

// GetTabTypeMetadata returns the TabTypeMetadata field value if set, zero value otherwise.
func (o *SignHere) GetTabTypeMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetTabTypeMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.TabTypeMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasTabTypeMetadata() bool {
	if o != nil && !IsNil(o.TabTypeMetadata) {
		return true
	}
...
func (o *SignHere) SetTabTypeMetadata(v PropertyMetadata) {
	o.TabTypeMetadata = &v
}

// GetTemplateLocked returns the TemplateLocked field value if set, zero value otherwise.
func (o *SignHere) GetTemplateLocked() string {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetTemplateLockedOk() (*string, bool) {
	if o == nil || IsNil(o.TemplateLocked) {
		return nil, false
	}
...
func (o *SignHere) HasTemplateLocked() bool {
	if o != nil && !IsNil(o.TemplateLocked) {
		return true
	}
...
func (o *SignHere) SetTemplateLocked(v string) {
	o.TemplateLocked = &v
}

// GetTemplateLockedMetadata returns the TemplateLockedMetadata field value if set, zero value otherwise.
func (o *SignHere) GetTemplateLockedMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetTemplateLockedMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.TemplateLockedMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasTemplateLockedMetadata() bool {
	if o != nil && !IsNil(o.TemplateLockedMetadata) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetTemplateRequiredOk() (*string, bool) {
	if o == nil || IsNil(o.TemplateRequired) {
		return nil, false
	}
...
func (o *SignHere) HasTemplateRequired() bool {
	if o != nil && !IsNil(o.TemplateRequired) {
		return true
	}
...
func (o *SignHere) SetTemplateRequired(v string) {
...
func (o *SignHere) GetTemplateRequiredMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetTemplateRequiredMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.TemplateRequiredMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasTemplateRequiredMetadata() bool {
	if o != nil && !IsNil(o.TemplateRequiredMetadata) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetTooltipOk() (*string, bool) {
	if o == nil || IsNil(o.Tooltip) {
		return nil, false
	}
...
func (o *SignHere) HasTooltip() bool {
	if o != nil && !IsNil(o.Tooltip) {
		return true
	}
...
func (o *SignHere) SetTooltip(v string) {
	o.Tooltip = &v
}

// GetToolTipMetadata returns the ToolTipMetadata field value if set, zero value otherwise.
func (o *SignHere) GetToolTipMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetToolTipMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.ToolTipMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasToolTipMetadata() bool {
	if o != nil && !IsNil(o.ToolTipMetadata) {
		return true
	}
...
func (o *SignHere) SetToolTipMetadata(v PropertyMetadata) {
	o.ToolTipMetadata = &v
}

// GetWidth returns the Width field value if set, zero value otherwise.
func (o *SignHere) GetWidth() string {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetWidthOk() (*string, bool) {
	if o == nil || IsNil(o.Width) {
		return nil, false
	}
	return o.Width, true
...
func (o *SignHere) SetWidth(v string) {
	o.Width = &v
}

// GetWidthMetadata returns the WidthMetadata field value if set, zero value otherwise.
func (o *SignHere) GetWidthMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetWidthMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.WidthMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasWidthMetadata() bool {
	if o != nil && !IsNil(o.WidthMetadata) {
		return true
	}
...
func (o *SignHere) SetWidthMetadata(v PropertyMetadata) {
	o.WidthMetadata = &v
}

// GetXPosition returns the XPosition field value if set, zero value otherwise.
func (o *SignHere) GetXPosition() string {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetXPositionOk() (*string, bool) {
	if o == nil || IsNil(o.XPosition) {
		return nil, false
	}
...
func (o *SignHere) HasXPosition() bool {
	if o != nil && !IsNil(o.XPosition) {
		return true
	}
...
func (o *SignHere) SetXPosition(v string) {
	o.XPosition = &v
}

// GetXPositionMetadata returns the XPositionMetadata field value if set, zero value otherwise.
func (o *SignHere) GetXPositionMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetXPositionMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.XPositionMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasXPositionMetadata() bool {
	if o != nil && !IsNil(o.XPositionMetadata) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetYPositionOk() (*string, bool) {
	if o == nil || IsNil(o.YPosition) {
		return nil, false
	}
...
func (o *SignHere) HasYPosition() bool {
	if o != nil && !IsNil(o.YPosition) {
		return true
	}
...
func (o *SignHere) SetYPosition(v string) {
	o.YPosition = &v
}

// GetYPositionMetadata returns the YPositionMetadata field value if set, zero value otherwise.
func (o *SignHere) GetYPositionMetadata() PropertyMetadata {
...
// and a boolean to check if the value has been set.
func (o *SignHere) GetYPositionMetadataOk() (*PropertyMetadata, bool) {
	if o == nil || IsNil(o.YPositionMetadata) {
		return nil, false
	}
...
func (o *SignHere) HasYPositionMetadata() bool {
	if o != nil && !IsNil(o.YPositionMetadata) {
		return true
	}
...
func (o *SignHere) SetYPositionMetadata(v PropertyMetadata) {
	o.YPositionMetadata = &v
}

func (o SignHere) MarshalJSON() ([]byte, error) {
...
func (o SignHere) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IsSealSignTab) {
		toSerialize["isSealSignTab"] = o.IsSealSignTab
	}
...
type NullableSignHere struct {
	value *SignHere
	isSet bool
}

func (v NullableSignHere) Get() *SignHere {
	return v.value
}

func (v *NullableSignHere) Set(val *SignHere) {
	v.value = val
	v.isSet = true
}

func (v NullableSignHere) IsSet() bool {
	return v.isSet
}

func (v *NullableSignHere) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSignHere(val *SignHere) *NullableSignHere {
	return &NullableSignHere{value: val, isSet: true}
}

func (v NullableSignHere) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSignHere) UnmarshalJSON(src []byte) error {
	v.isSet = true
